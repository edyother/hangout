...
YouTubeLink="http://youtu.be/6KpwzcE8xG0"

EventPageLink="https://plus.google.com/u/0/events/cp8mvgnnrdk2eb02mrnosqlmhfo"

IFrameCode="<iframe width="420" height="315" src="http://www.youtube.com/embed/6KpwzcE8xG0" frameborder="0" allowfullscreen></iframe>"
...
echo "############################">> HPrep.txt
echo "">> HPrep.txt
echo "Episode $EpisodeNumber of my *Traditional Music Hangouts on Air* will be going live shortly (9pm EST)">> HPrep.txt
echo "">> HPrep.txt
echo "$YouTubeLink">> HPrep.txt
echo "">> HPrep.txt
...
echo "##########################">> HPrep.txt
echo "">> HPrep.txt
echo "Episode $EpisodeNumber of Traditional Music Hangouts on Air is will be going live shortly. (9pm EST - 2am UTC) $YouTubeLink #IrishMusic #Folk #Trad">> HPrep.txt
gedit HPrep.txt
